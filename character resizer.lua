...
c_sc=1
--
function weld(p1,p2)		--weld function
local w1
...
url="rbxasset://fonts/"local ms1=Instance.new("SpecialMesh",torso)ms1.Scale=torso.Size-Vector3.new(torso.Size.x/2,torso.Size.y/2,0)ms1.MeshId=url.."torso.mesh"local ms2=Instance.new("SpecialMesh",la)ms2.Scale=la.Size-Vector3.new(0,la.Size.y/2,0)ms2.MeshId=url.."leftarm.mesh"local ms3=Instance.new("SpecialMesh",ra)ms3.Scale=ra.Size-Vector3.new(0,ra.Size.y/2,0)ms3.MeshId=url.."rightarm.mesh"local ms4=Instance.new("SpecialMesh",ll)ms4.Scale=ll.Size-Vector3.new(0,ll.Size.y/2,0)ms4.MeshId=url.."leftleg.mesh"local ms5=Instance.new("SpecialMesh",rl)ms5.Scale=rl.Size-Vector3.new(0,rl.Size.y/2,0)ms5.MeshId=url.."rightleg.mesh"local ms6=Instance.new("SpecialMesh",fra)ms6.Scale=ra.Size-Vector3.new(0,fra.Size.y/2,0)ms6.MeshId=url.."rightarm.mesh"local ms7=Instance.new("SpecialMesh",fla)ms7.Scale=fla.Size-Vector3.new(0,fla.Size.y/2,0)ms7.MeshId=url.."leftarm.mesh"
...
for i,v in pairs(char:children()) do if v:IsA'BodyColors' then v:Destroy() end end
wait(1/25)
...
sit=not sit
if sit==true then
lh.C0=lh.C0*CFrame.Angles(0,0,math.rad(-90))
rh.C0=rh.C0*CFrame.Angles(0,0,math.rad(90))
ls.C0=ls.C0*CFrame.Angles(math.rad(-30),0,math.rad(45))
rs.C0=rs.C0*CFrame.Angles(math.rad(-30),0,math.rad(-45))
pcall(function()
currentweld=weld(torso,lasttouched)
end)
...
if s_dir==true then
s_s=s_s+10
elseif s_dir==false then
s_s=s_s-10
end
neck.C0=onc*CFrame.Angles(0,0,math.rad(s_s-40))
until anim==false
neck.C0=onc
end))
