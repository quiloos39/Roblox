...
--simple2D.setParent(workspace) It isn't neccesary since we ran setup function and defined parent of it. Now all instances that created by it will be parented to screen.
-- and so on...
